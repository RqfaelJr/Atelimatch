...
public record DadosDetalhamentoAtelie(Integer idPessoa, String nomePessoa,
    ...
    public DadosDetalhamentoAtelie(Atelie atelie) {
        this(atelie.getIdPessoa(), atelie.getNomePessoa(), atelie.getEmail(), atelie.getSenha(), atelie.getUsuario(), atelie.getTelefone(), atelie.getNotaAvaliacao(), atelie.getQntdNotas(), atelie.getEspecialidade().getDescricaoEspecialidade(), atelie.getServicos().stream().map(Servico::getNomeServico).collect(Collectors.toList()), atelie.getInicio01(), atelie.getFim01(), atelie.getInicio02(), atelie.getFim02(), atelie.getCnpj(), atelie.getEndereco().getIdEndereco());
    }
}
